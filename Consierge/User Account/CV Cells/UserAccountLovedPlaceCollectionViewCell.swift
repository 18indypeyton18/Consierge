//
//  UserAccountLovedPlaceCollectionViewCell.swift
//  Consierge
//
//  Created by Austin McLaughlin on 10/28/24.
//

import UIKit

class UserAccountLovedPlaceCollectionViewCell: UICollectionViewCell {
    
    @IBOutlet var placePic: UIImageView!
    @IBOutlet var placeNameLabel: UILabel!
    @IBOutlet var dateLovedLabel: UILabel!
    ...
    weak var delegate: UserAccountLovedPlaceCollectionViewCellDelegate?
...
extension UserAccountLovedPlaceCollectionViewCell: UIContextMenuInteractionDelegate {
...
protocol UserAccountLovedPlaceCollectionViewCellDelegate: AnyObject {
