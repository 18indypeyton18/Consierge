//
//  RankedPlaceCollectionViewCell.swift
//  Consierge
//
...
class RankedPlaceCollectionViewCell: UICollectionViewCell {
    ...
    weak var delegate: RankedPlaceCollectionViewCellDelegate?
...
extension RankedPlaceCollectionViewCell: UIContextMenuInteractionDelegate {
...
extension RankedPlaceCollectionViewCell: PicGetterDelegate {
    func updatePic(image: UIImage?, placeID: Int?) {
        
        guard placeID == nil || placeID == place?.id else { return }
...
extension RankedPlaceCollectionViewCell {
...
protocol RankedPlaceCollectionViewCellDelegate: AnyObject {
